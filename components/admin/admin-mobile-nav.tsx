  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex min-h-10 items-center justify-center rounded-[var(--radius-md)] border border-border px-3 type-button hover:bg-surface-muted"
      >
        {open ? "Close" : "Menu"}
      </button>
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-12 z-[var(--layer-navigation)] w-[min(18rem,calc(100vw-2rem))] border border-border bg-surface p-4 shadow-[var(--shadow-md)]"
        >
