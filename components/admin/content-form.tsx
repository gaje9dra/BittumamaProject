    ...
    <form action={formAction} className="space-y-8">
      ...
      {domain === "workshops" && (
        <section className="grid gap-6 lg:grid-cols-2">
          ...
          <div><label htmlFor="registrationDeadline" className="text-sm font-medium">Registration deadline (UTC)</label><Input name="registrationDeadline" value={values.registrationDeadline ? new Date(values.registrationDeadline).toISOString().slice(0,16) : ""} type="datetime-local" error={errors.registrationDeadline} /></div>
