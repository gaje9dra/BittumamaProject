  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto grid min-h-screen max-w-[var(--container-wide)] lg:grid-cols-[minmax(0,1.15fr)_minmax(28rem,.85fr)]">
        <section className="relative overflow-hidden border-b border-border px-[var(--page-gutter)] py-10 sm:py-14 lg:border-b-0 lg:border-r lg:px-12 lg:py-16 xl:px-16" aria-label="SkillVeda authentication identity">
