  ...
  return (
    <SceneFrameShell>
      <div className="flex h-full flex-col gap-4 sm:gap-5">
        ...
        <footer className="grid grid-cols-3 gap-2 border-t border-[var(--dark-border)] pt-3 text-[8px] uppercase tracking-[0.12em] text-[var(--dark-muted-foreground)] sm:text-[9px]"><span>Research markers</span><span className="text-center">Methodology</span><span className="text-right">Data visualization</span></footer>
      </div>
    </SceneFrameShell>
  );
}
