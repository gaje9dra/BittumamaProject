        ...
        <ScrollTransition distance={44}>
          <div className="text-center">
            ...
            <h2
              ...
              className="mx-auto mt-3 max-w-[16ch] font-display text-[clamp(2.5rem,5vw,4.5rem)] font-semibold leading-[0.98] tracking-[-0.045em] text-foreground"
            >
              Our <span className="text-[#b3130d]">Services</span>
            </h2>
            <p className="mx-auto mt-5 max-w-[52rem] text-[1rem] leading-7 text-muted-foreground sm:text-[1.05rem]">
            ...
            {HOME_SERVICE_CARDS.map((card) => {
              ...
              return (
                <Link
                  ...
                  className="group relative min-h-[24rem] overflow-hidden rounded-[0.55rem] bg-[#173f6b] px-6 py-7 text-white shadow-[0_10px_30px_rgba(20,50,82,.08)] transition-[transform,box-shadow] duration-200 ease-out hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(20,50,82,.18)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#173f6b]"
                >
                  ...
                  <div className="relative flex h-full min-h-[22rem] flex-col">
                    <div className="flex items-start justify-between">
                      <span className="font-display text-4xl font-semibold tracking-[-0.04em] text-white/20">
                        {card.number}
                      </span>
                      <span className="flex size-12 items-center justify-center rounded-lg border border-[#d7b900]/60 bg-[#234b70]/90 text-[#ffd400]">
                        <Icon aria-hidden="true" className="size-6" />
                      </span>
                    </div>

                    <div className="mt-auto">
                      <h3 className="max-w-[14ch] font-display text-[1.55rem] font-semibold leading-[1.08] tracking-[-0.025em]">
                        {card.title}
                      </h3>
                      <span className="mt-4 block h-[3px] w-9 bg-[#ffd400] transition-[width] duration-200 group-hover:w-14" />
                      <p className="mt-5 max-w-[32ch] text-[0.9rem] leading-6 text-white/80">
                        {card.description}
                      </p>

                      <span className="mt-7 inline-flex min-h-10 items-center gap-3 text-[0.72rem] font-bold uppercase tracking-[0.14em] text-[#ffd400]">
                        Learn More
                        <span className="flex size-7 items-center justify-center rounded-full border border-[#ffd400]">
