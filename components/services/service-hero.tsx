      ...
      <Container size="wide" className="py-8 sm:py-10 lg:py-12">
        ...
        <div className="mt-8 grid gap-7 lg:grid-cols-12 lg:items-end lg:gap-x-8 xl:gap-x-12">
          <div className="lg:col-span-8">
            ...
            <Heading id="service-title" level={1} className="mt-3 max-w-[16ch]">
              {service.title}
            </Heading>
          </div>
          <div className="lg:col-span-4 lg:col-start-9">
            <p className="type-body-lg max-w-[42ch] text-muted-foreground">{service.shortDescription}</p>
            <Button asChild size="lg" className="group mt-6 w-fit">
              <Link href="/contact">
                {isComingSoon ? "Ask About This Service" : "Discuss This Service"}
