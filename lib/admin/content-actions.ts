...
function readForm(formData: FormData) {
  const fields: Record<string, string> = {
    ...
    registrationEnabled: formData.get("registrationEnabled") === "true" ? "true" : "false",
    registrationCapacity: value(formData, "registrationCapacity"),
    registrationDeadline: value(formData, "registrationDeadline"),
    registrationMode: value(formData, "registrationMode"),
