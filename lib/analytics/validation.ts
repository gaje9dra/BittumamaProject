...
export function validateAnalyticsEventInput(input: { eventName: AnalyticsEventName; path?: string | null; contentId?: string | null; metadata?: unknown; anonymousId?: string | null; sessionId?: string | null }) {
